  ...
  render() {
    return (
      <div class="Block-1 Block-1-Full Block-1-Type-Header">
        <div class="Element-2-Type-Header-Image">
          <img class="Subelem-3-Type-Header-Image" src={logo} alt="logo" />
        </div>
        <div class="Element-2-Type-Header-Text">
          <p class="Subelem-3-Type-Header-Text">
