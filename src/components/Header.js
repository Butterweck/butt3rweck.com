  ...
  render() {
    return (
      <div class="Block-1 Block-1-Full Block-1-Type-Header">
        <img class="Element-2-Type-Header-Image" src={profile} alt="profile" />
        <p class="Element-2-Type-Header-Text">
          Working with Scrum since almost 5 years, I am convinced that the
          success or failure of a dev team is highly depending on the degree of
          transparency that the team shows - both towards external and internal
          stakeholders.
          <br />
          &nbsp;
          ...
          technical level. The most important thing I can support a team with is
          taking different perspectives, mediate and translate.
        </p>
      </div>
    );
  }
